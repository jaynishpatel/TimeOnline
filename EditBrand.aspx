   ...
   <pre>                                                                                                                    <a href="LoginPage.aspx">Log Out</a></pre>
     ...
     <form id="AddBrand" runat="server">
        <p><h3>Edit Brand</h3>
         ...
         <center><asp:Button ID="UpdateBrand" Text="Update" runat="server" cssclass="btn-dark" ></asp:Button>&nbsp;&nbsp;
            <asp:Button ID="CancelBrand" Text="Cancel" runat="server" OnClick="CancelBrand_Click" cssclass="btn-dark"></asp:Button></center>
