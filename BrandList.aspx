...
.tabcontent {
  ...
  <a href ="ProductList.aspx"<button class="tablinks" onclick="openCity(event, 'Products')">Products</button></a>
</div>
  ...
  <pre>                                                                                                                    <a href="LoginPage.aspx">Log Out</a></pre>
     ...
     <form id="AddBrand" runat="server">
        <p><h3>Brand List</h3>
         ...
         <center><asp:Button ID="AddBrandButton1" Text="Add Brand" runat="server" OnClick="AddBrandButton1_Click" cssclass="btn-dark"></asp:Button></center>
